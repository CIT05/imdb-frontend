            ...
            <section>
                ...
                <div className={style.flexContainer}>
                    {luckyTitles.map((luckyTitle) => (
                        <Card
                            key={'title' + luckyTitle.tConst}
                            onClick={() => navigate(`/title/${luckyTitle.tConst}`)}
                            variant="flush"
                            className="bg-dark text-light"
                            style={{ width: '18rem', height: '18rem', cursor: 'pointer' }}
                        >
                            {luckyTitle.poster && luckyTitle.poster !== 'N/A' ? (
                                <Card.Img
                                    style={{
                                        width: '100%',
                                        height: '10rem',
                                ...
                                <Card.Img
                                    ...
                                    variant="top"
                                    src={`https://picsum.photos/200/300?random=${luckyTitle.tConst}`}
                                />
                            )}

                            <Card.Header>{luckyTitle.primaryTitle}</Card.Header>
                            <Card.Body>
                                <Card.Title>
                                    <div className="d-flex justify-content-between">
                                        <p>
                                            Rating: {luckyTitle.rating?.averageRating || ''}{' '}
                                            <i className="bi bi-star-fill text-warning"></i>
                                        </p>
                                    </div>
                                </Card.Title>
